...
<div class="bg-white p-2 sm:px-6 sm:py-4 border-b border-gray-150">
    ...
    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
            {{ trans('global.create') }} {{ trans('line-ups.competitions.title') }}
        </h3>
    ...
    <form wire:submit.prevent="submit" class="p-4 md:p-5">
        <div class="grid gap-4 mb-4 grid-cols-2">
            ...
            <div class="{{ $errors->has('competition.year_id') ? 'invalid' : '' }}">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white required" for="round.team_id">{{ trans('line-ups.competitions.fields.year') }}</label>
                <x-select
