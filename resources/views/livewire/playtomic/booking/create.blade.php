        ...
        <form wire:submit.prevent="submit" class="pt-3">
            <div class="grid lg:grid-cols-2 md:grid-cols-2 xs:grid-cols-1 xl:grid-cols-1">
                ...
                <div class="w-full">
                    ...
                    <div class="mb-2 {{ $errors->has('booking.booking_preference') ? 'invalid' : '' }}">
                    ...
                    <div class="mb-2 {{ $errors->has('booking.player_email') ? 'invalid' : '' }}">
                    ...
                    <div class="flex justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" class="sr-only peer" id="ck_public" name="ck_public" wire:model="booking.public">
                            <div
            ...
            <div class="w-full items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button type="submit" class="float-right text-white bg-teal-400 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    {{ trans('global.save') }}
                </button>
