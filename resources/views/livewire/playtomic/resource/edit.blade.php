    ...
    <div class="w-2/3 p-4 border border-gray-200 bg-gray-50 rounded-t-xl dark:border-gray-600 dark:bg-gray-700">
        ...
        <form wire:submit.prevent="submit" class="pt-3">
            <div class="w-1/2">
                ...
                <div class="{{ $errors->has('resource.name') ? 'invalid' : '' }}">
                ...
                <div class="{{ $errors->has('resource.playtomic_id') ? 'invalid' : '' }}">
                ...
                <div class="{{ $errors->has('resource.priority') ? 'invalid' : '' }}">
