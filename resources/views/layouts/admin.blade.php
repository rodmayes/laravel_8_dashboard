...
<body class="sidebar-mini-md accent-warning text-sm layout-navbar-fixed" style="height: auto;">
    ...
    <div id="app" class="wrapper">
        ...
        <aside class="main-sidebar elevation-4 sidebar-light-warning">
            <a href="{{ route("admin.home") }}" class="brand-link bg-warning bg-navy bg-purple bg-lightblue bg-teal bg-cyan bg-gray-dark text-sm">
                <img src="{{ asset('images/letter-r.jpeg') }}" alt="Rodmayes" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <script>
        $(document).ready(function() {
            $('[data-widget="pushmenu"]').PushMenu({enableRemember: true});
        })
    </script>
        @yield('scripts')
        @stack('scripts')
